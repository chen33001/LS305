...
#加變相中文解釋
TCM_Anova_p_value_meaning1 <- c("陰虛","陽虛","痰瘀","陰虛+陽虛",
                                "陰虛+痰瘀","陽虛+痰瘀",
                                "陰虛+陽虛+痰瘀","殘餘")
TCM_Anova_p_value <- rbind(TCM_Anova_p_value_meaning1, TCM_Anova_p_value)

TCM_Anova_p_value_meaning2 <- c(" ","身高","體重","身體質量指數","體脂肪率","腰圍","臀圍","腰臀比",
                                "靜坐時第一次收縮壓","靜坐時第一次舒張壓",
                                "靜坐時第二次收縮壓","靜坐時第二次舒張壓",
                                "靜坐時第三次收縮壓","靜坐時第三次舒張壓",
...
write.xlsx(TCM_Anova_p_value, file='C:\\R\\LS305中醫\\TCM_Anova_p_value.xlsx',fileEncoding = "Big5")
